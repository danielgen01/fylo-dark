...
const CTABannerBottom = () => {
	return (
		<section className="mx-5 bg-Dark-Blue-testimonials-background h-96 relative -mt-32 rounded-xl shadow-md shadow-black py-10 px-10 flex flex-col items-center gap-5">
			...
			<p className="text-white/80 font-medium text-center">
				...
				generous. If you have any questions, our suppor team would be happy to
				help you.
			</p>
			<input
				type="text"
